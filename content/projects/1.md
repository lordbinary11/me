...
title: Verdiscan
description: >-
  Mobile app that uses AI to detect crop diseases from leaf photos, helping
  farmers protect their harvests with instant diagnosis.
date: 'March 14, 2026'
...
├─────────────────────────────┼───────────────────────────────────┼─────────────────────┤
│ [API Setup Guide]            │   Complete backend setup after    │  /API_SETUP_GUIDE.md │
│ (API_SETUP_GUIDE.md)        │              cloning              │                     │
│ [Model Training Guide]       │ Train your own disease detection │/MODEL_TRAINING_GUIDE.md│
│ (MODEL_TRAINING_GUIDE.md)   │              models              │                     │
│ [API Documentation]          │      FastAPI endpoints and       │ /model/api/README.md │
│ (model/api/README.md)       │               usage              │                     │
│ [Installation Guide]         │      Detailed dependency setup    │   /model/INSTALL.md  │
│ (model/INSTALL.md)          │                                   │                     │
└─────────────────────────────┴───────────────────────────────────┴─────────────────────┘
```
...
```
┌─────────────┬─────────┬─────────┬─────────┬─────────────┐
│   Metric    │ Cassava │  Maize  │ Tomato  │ Model Size  │
├─────────────┼─────────┼─────────┼─────────┼─────────────┤
│  Accuracy   │   83%   │   95%   │   95%   │             │
│   Classes   │    5    │    4    │   10    │             │
...
[⭐ Star this project](https://github.com/lordbinary1/verdiscan) if you find it useful!
